 ...
 */
package com.redip.servlet.impact;
 ...
 * @author bcivel
 */
public class NonConformityUpdateImpact extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        String str = nonconformitiesImpactService.updateNonconformityImpact(login, columnName, value);
        out.print(str);
    }
}