 ...
 * @author bcivel
 */
public class GetDistinctValueFromNonconformitiesAction extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        IQualityNonconformitiesActionService nqcService = appContext.getBean(IQualityNonconformitiesActionService.class);
        try {
