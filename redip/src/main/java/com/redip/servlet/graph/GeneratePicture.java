...
public class GeneratePicture extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String fromWeek = "";
            if (request.getParameter("fromWeek")!=null && !request.getParameter("fromWeek").equals("")){
            fromWeek = request.getParameter("fromWeek");
            }
            String toWeek = "";
            if (request.getParameter("toWeek")!=null && !request.getParameter("toWeek").equals("")){
...
//                }
                ...
                if (!fromWeek.equals("") && !toWeek.equals("")) {
                    if (incrementFromTo >= Integer.valueOf(fromWeek) && incrementFromTo <= Integer.valueOf(toWeek)){
